...
ActiveQuery Code of Conduct Policy applies within all parts of ActiveQuery projects, programmes,
respositeries, spaces, and it also applies when an individual is representing the ActiveQuery,
its projects, programmes, respositeries, spaces or its community in public spaces.

ActiveQuery Code of Conduct Policy also applies outside the ActiveQ projects, programmes, respositeries,
spaces when there is a reasonable belief that an individual's behavior may have a negative impact on
the ActiveQuery or its community.

Examples of representing a ActiveQuery or community include to using an official
